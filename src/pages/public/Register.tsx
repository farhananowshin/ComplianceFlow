            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="flex items-start gap-3.5 p-3.5 rounded-lg bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                    Clear permissions for Organization Admins and Employees with audit trail logging.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3.5 p-3.5 rounded-lg bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                ...
                <div>
                  <h2 className="text-xs font-semibold text-slate-900 dark:text-white">Executive Compliance Visibility</h2>
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
